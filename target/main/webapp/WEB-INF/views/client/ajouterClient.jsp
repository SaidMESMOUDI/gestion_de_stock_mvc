								...
								<f:form modelAttribute="client" method="POST" action="${urlEnregistrer }" enctype="multipart/form-data" role="form" >
									<div class="card-body">
										<div class="form-group">
											...
											<f:input type="text" path="nom" id="nom" class="form-control" placeholder="Nom" />
										</div>
										<div class="form-group">
											<label for="prenom"><fmt:message key="common.prenom" /></label>
											<f:input type="text" path="prenom" id="prenom" class="form-control" placeholder="Prénom" />
										</div>
										<div class="form-group">
											<label for="adresse"><fmt:message key="common.adresse" /></label> 
											<f:input type="text" path="adresse" id="adresse" class="form-control" placeholder="Adresse" />
										</div>
										<div class="form-group">
											...
											<div class="input-group mb-2 mr-sm-2">
												...
												<f:input type="text" path="mail" id="mail" class="form-control" placeholder="E-mail" />
											</div>
										</div>
										<div class="form-group">
											<label for="customFile"><fmt:message key="common.photo" /></label>
											<%-- <f:input path="photo" type="file" class="form-control" id="customFile" placeholder="Choisir une photo"/> --%>
											<div class="custom-file">
												<f:input path="photo" type="file" class="custom-file-input" id="customFile" />
											    <label class="custom-file-label" for="customFile" placeholder="Choisir une photo"></label>
											 </div>
