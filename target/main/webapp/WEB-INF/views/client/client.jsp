					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover text-sm table-sm w-100"
									...
									<tbody>
										<c:forEach items="${clients}" var="client">
											<tr>
												<td>
													<c:out value="${client.getPhoto()}" />
													<img src="${client.getPhoto()}" class="rounded img-thumbnail mx-auto d-block" width="50px" height="50px" />
												</td>
